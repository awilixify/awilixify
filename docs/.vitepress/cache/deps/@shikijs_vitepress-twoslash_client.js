  ...
  if (typeof window !== "undefined") {
    ...
    window.addEventListener("click", (e) => {
      if (e.composedPath().some((el) => {
        var _a2, _b2, _c2, _d;
        return ((_b2 = (_a2 = el == null ? void 0 : el.classList) == null ? void 0 : _a2.contains) == null ? void 0 : _b2.call(_a2, "vp-code-group")) || ((_d = (_c2 = el == null ? void 0 : el.classList) == null ? void 0 : _c2.contains) == null ? void 0 : _d.call(_c2, "tabs"));
      })) tt();
    }, { passive: true });
    if (!isMobile) {
  ...
  app.use(Gt, {
    ...
    themes: {
      ...
      "twoslash": {
        ...
        ...((_a = options.themes) == null ? void 0 : _a.twoslash) ?? {}
      },
      "twoslash-query": {
        $extend: "twoslash",
        triggers: ["click"],
        ...
        autoHide: false,
        noAutoFocus: true,
        ...((_b = options.themes) == null ? void 0 : _b["twoslash-query"]) ?? {}
      },
      "twoslash-completion": {
        ...
        distance: 0,
        arrowOverflow: true,
        ...((_c = options.themes) == null ? void 0 : _c["twoslash-completion"]) ?? {}
      }
    }
  });
} };
